// Server-side word list for Wordle
...
export const SOLUTIONS = [
  ...
  'dough', 'douse', 'dowdy', 'dowel', 'downy', 'dowry', 'dozen', 'draft', 'drain', 'drake',
  ...
  'dunce', 'dusty', 'dutch', 'duvet', 'dwarf', 'dwell', 'dwelt', 'dying', 'eager', 'eagle',
  'early', 'earth', 'easel', 'eaten', 'eater', 'ebony', 'eclat', 'edict', 'edify', 'eerie',
  'egret', 'eight', 'eject', 'elate', 'elbow', 'elder', 'elect', 'elegy', 'elfin', 'elite',
  'elope', 'elude', 'email', 'embed', 'ember', 'emcee', 'empty', 'enact', 'endow', 'enemy',
  'enjoy', 'ennui', 'ensue', 'enter', 'entry', 'envoy', 'epoch', 'epoxy', 'equal', 'equip',
  'erase', 'erect', 'erode', 'error', 'erupt', 'essay', 'ether', 'ethos', 'evade', 'event',
  'every', 'evict', 'evoke', 'exact', 'exalt', 'excel', 'exert', 'exile', 'exist', 'expat',
  'expel', 'extol', 'extra', 'exude', 'exult', 'fable', 'facet', 'faint', 'fairy', 'faith',
  ...
  'fraud', 'freak', 'freed', 'fresh', 'friar', 'fried', 'frill', 'frisk', 'frizz', 'frock',
  'frond', 'front', 'frost', 'froth', 'frown', 'froze', 'fruit', 'fudge', 'fugue', 'fully',
  'fungi', 'funky', 'funny', 'furor', 'furry', 'fussy', 'fusty', 'fuzzy', 'gaffe', 'gaily',
  'gamer', 'gamma', 'gamut', 'gassy', 'gaudy', 'gauge', 'gaunt', 'gauze', 'gavel', 'gawky',
  'gazer', 'gecko', 'geeky', 'geese', 'genie', 'genre', 'ghost', 'giant', 'giddy', 'gills',
  'given', 'giver', 'glade', 'gland', 'glare', 'glass', 'glaze', 'gleam', 'glean', 'glide',
  'glint', 'gloat', 'globe', 'gloom', 'glory', 'gloss', 'glove', 'glyph', 'gnash', 'gnome',
  'godly', 'going', 'golly', 'gonad', 'goner', 'goody', 'gooey', 'goofy', 'goose', 'gorge',
  'gouge', 'gourd', 'grace', 'grade', 'graft', 'grail', 'grain', 'grand', 'grant', 'grape',
  'graph', 'grasp', 'grass', 'grate', 'grave', 'gravy', 'graze', 'great', 'greed', 'green',
  'greet', 'grief', 'grill', 'grime', 'grimy', 'grind', 'gripe', 'grits', 'groan', 'groin',
  'groom', 'grope', 'gross', 'group', 'grout', 'grove', 'growl', 'grown', 'gruel', 'gruff',
  'grunt', 'guava', 'guess', 'guest', 'guide', 'guild', 'guilt', 'guise', 'gulch', 'gully',
  'gumbo', 'gummy', 'guppy', 'gusto', 'gusty', 'habit', 'hairy', 'halve', 'handy', 'happy',
  'hardy', 'harem', 'harpy', 'harry', 'harsh', 'haste', 'hasty', 'hatch', 'hater', 'haunt',
  'haute', 'haven', 'havoc', 'hazel', 'heady', 'heart', 'heath', 'heave', 'heavy', 'hedge',
  ...
  'hyena', 'hyper', 'icily', 'icing', 'ideal', 'idiom', 'idiot', 'idler', 'igloo', 'image',
  'imbue', 'impel', 'imply', 'inane', 'inbox', 'incur', 'index', 'indie', 'inept', 'inert',
  'infer', 'ingot', 'inlay', 'inlet', 'inner', 'input', 'inter', 'intro', 'ionic', 'irate',
  'irony', 'islet', 'issue', 'itchy', 'ivory', 'jaunt', 'jazzy', 'jelly', 'jerky', 'jewel',
  'jiffy', 'joint', 'joist', 'joker', 'jolly', 'joust', 'judge', 'juice', 'juicy', 'jumbo',
  'jumpy', 'juror', 'karma', 'kayak', 'kebab', 'khaki', 'kinky', 'kiosk', 'kitty', 'knack',
  ...
  'leaky', 'leapt', 'learn', 'lease', 'leash', 'least', 'leave', 'ledge', 'leech', 'leery',
  'lefty', 'legal', 'leggy', 'lemon', 'lemur', 'level', 'lever', 'libel', 'light', 'liken',
  ...
  'magic', 'magma', 'maize', 'major', 'maker', 'mambo', 'mamma', 'mammy', 'manga', 'mango',
  ...
  'metro', 'micro', 'midge', 'midst', 'might', 'milky', 'mimic', 'mince', 'minor', 'minty',
  ...
  'nutty', 'nylon', 'nymph', 'oaken', 'oasis', 'occur', 'ocean', 'octet', 'oddly', 'offal',
  'offer', 'often', 'olden', 'older', 'olive', 'omega', 'onion', 'onset', 'opera', 'opine',
  'opium', 'optic', 'orbit', 'order', 'organ', 'other', 'otter', 'ought', 'ounce', 'outdo',
  'outer', 'ovary', 'overt', 'owing', 'owner', 'oxide', 'ozone', 'paddy', 'pagan', 'paint',
  'paler', 'palsy', 'panel', 'panic', 'pansy', 'papal', 'paper', 'parka', 'parry', 'parse',
  ...
  'pleat', 'plied', 'pluck', 'plumb', 'plume', 'plump', 'plunk', 'plush', 'poach', 'point',
  ...
  'prune', 'psalm', 'pubic', 'pudgy', 'pulse', 'punch', 'pupil', 'puppy', 'puree', 'purer',
  ...
  'radar', 'radii', 'radio', 'radon', 'rainy', 'raise', 'rally', 'ramen', 'ranch', 'randy',
  'range', 'rapid', 'rarer', 'raspy', 'ratio', 'ratty', 'raven', 'rayon', 'razor', 'reach',
  'react', 'ready', 'realm', 'rebel', 'rebut', 'recap', 'recur', 'recut', 'reedy', 'refer',
  ...
  'roast', 'robin', 'robot', 'rocky', 'rodeo', 'rogue', 'roomy', 'roost', 'rotor', 'rouge',
  ...
  'scent', 'scion', 'scoff', 'scold', 'scone', 'scoop', 'scoot', 'scope', 'score', 'scorn',
  'scout', 'scowl', 'scram', 'scrap', 'scree', 'screw', 'scrub', 'scrum', 'seamy', 'sedan',
  'seedy', 'segue', 'seize', 'sense', 'sepia', 'serif', 'serum', 'serve', 'setup', 'seven',
  ...
  'shyly', 'siege', 'sight', 'sigma', 'silky', 'silly', 'since', 'sinew', 'singe', 'siren',
  'sissy', 'sixth', 'sixty', 'skate', 'skier', 'skiff', 'skill', 'skimp', 'skirt', 'skull',
  ...
  'sooty', 'sorry', 'sound', 'south', 'space', 'spade', 'spank', 'spare', 'spark', 'spasm',
  'spawn', 'speak', 'spear', 'speck', 'speed', 'spell', 'spend', 'spent', 'spice', 'spicy',
  'spied', 'spiel', 'spike', 'spill', 'spine', 'spiny', 'spire', 'spite', 'splat', 'split',
  ...
  'sunny', 'super', 'surer', 'surge', 'surly', 'sushi', 'swami', 'swamp', 'swank', 'swarm',
  ...
  'taker', 'tally', 'talon', 'tamer', 'tango', 'tangy', 'taper', 'tapir', 'tardy', 'taste',
  ...
  'tipsy', 'titan', 'title', 'toast', 'today', 'toddy', 'token', 'tonal', 'toner', 'tonic',
  ...
  'trice', 'trick', 'tried', 'tripe', 'trite', 'troll', 'tromp', 'troop', 'trope', 'troth',
  'trout', 'trove', 'truce', 'truck', 'truly', 'trump', 'trunk', 'truss', 'trust', 'truth',
  'tryst', 'tuber', 'tulip', 'tulle', 'tumor', 'tuner', 'tunic', 'turbo', 'tutor', 'twang',
  'tweak', 'tweed', 'tweet', 'twice', 'twigs', 'twill', 'twine', 'twirl', 'twist', 'tying',
  ...
  'usurp', 'utter', 'vague', 'valid', 'valor', 'value', 'valve', 'vapid', 'vapor', 'vault',
  ...
  'warty', 'waste', 'watch', 'water', 'waver', 'waxen', 'weary', 'weave', 'webby', 'wedge',
  'weedy', 'weigh', 'weird', 'welch', 'welsh', 'wench', 'whack', 'whale', 'wharf', 'wheat',
  'wheel', 'whelp', 'where', 'which', 'whiff', 'while', 'whine', 'whiny', 'whirl', 'whisk',
  'white', 'whole', 'whoop', 'whose', 'widen', 'wider', 'widow', 'width', 'wield', 'willy',
...
// Valid guesses includes all solutions plus more
export const VALID_GUESSES = new Set([
  ...SOLUTIONS,
  'aahed', 'aalii', 'aargh', 'abaca', 'abaci', 'abacs', 'abaft', 'abaka', 'abase', 'abash',
  'abate', 'abaya', 'abbas', 'abbed', 'abbes', 'abbot', 'abcee', 'abeam', 'abear', 'abele',
  'abers', 'abets', 'abhor', 'abide', 'abies', 'abled', 'abler', 'ables', 'ablet', 'ablow',
  'abmho', 'abode', 'abohm', 'aboil', 'aboma', 'aboon', 'abord', 'abore', 'abort', 'about',
  'above', 'abram', 'abray', 'abrim', 'abris', 'absey', 'absit', 'abuna', 'abune', 'abuse',
  'abuts', 'abuzz', 'abyes', 'abysm', 'abyss', 'acais', 'acari', 'accas', 'accoy', 'acerb',
  'acers', 'aceta', 'acids', 'acidy', 'acing', 'acini', 'ackee', 'acker', 'acmes', 'acmic',
  'acned', 'acnes', 'acock', 'acold', 'acorn', 'acred', 'acres', 'acrid', 'acted', 'actin',
  'actor', 'acute', 'adage', 'adapt', 'adaws', 'adays', 'addax', 'added', 'adder', 'addio',
  'addle', 'adeem', 'adept', 'adhan', 'adieu', 'adios', 'adits', 'adman', 'admen', 'admin',
  'admit', 'admix', 'adobe', 'adobo', 'adopt', 'adore', 'adorn', 'adown', 'adoze', 'adult',
  'adunc', 'adust', 'advew', 'adyta', 'adzed', 'adzes', 'aeons', 'aerie', 'afald', 'afara',
  'afars', 'afear', 'affix', 'afire', 'aflaj', 'afoot', 'afore', 'afoul', 'afrit', 'afros',
  'after', 'again', 'agama', 'agami', 'agape', 'agars', 'agast', 'agate', 'agave', 'agaze',
  'agene', 'agent', 'agers', 'agger', 'aggie', 'aggro', 'aggry', 'aghas', 'agila', 'agile',
  'aging', 'agios', 'agism', 'agist', 'agita', 'aglet', 'agley', 'agloo', 'aglow', 'aglus',
  'agmas', 'agoge', 'agone', 'agons', 'agony', 'agora', 'agree', 'agria', 'agrin', 'agued',
  'agues', 'ahead', 'aheap', 'ahent', 'ahigh', 'ahind', 'ahing', 'ahint', 'ahold', 'ahull',
  'ahuru', 'aided', 'aider', 'aides', 'aidoi', 'aidos', 'aiery', 'aigas', 'aight', 'ailed',
  'aimed', 'aimer', 'ainee', 'ainga', 'aioli', 'aired', 'airer', 'airns', 'airth', 'airts',
  'aisle', 'aitch', 'aitus', 'aiver', 'aiyee', 'aizle', 'ajies', 'ajiva', 'ajuga', 'akees',
  ...
  'alula', 'alums', 'alure', 'alvar', 'alway', 'amahs', 'amain', 'amass', 'amate', 'amaze',
  'amban', 'amber', 'ambit', 'amble', 'ambos', 'ambry', 'ameba', 'ameer', 'amend', 'amene',
  'amens', 'ament', 'amias', 'amice', 'amici', 'amide', 'amido', 'amids', 'amies', 'amiga',
  'amigo', 'amine', 'amino', 'amins', 'amirs', 'amiss', 'amity', 'amlas', 'amman', 'ammon',
  'ammos', 'amnia', 'amnic', 'amnio', 'amoks', 'amole', 'among', 'amort', 'amour', 'amove',
  'amped', 'ample', 'amply', 'ampul', 'amrit', 'amuck', 'amuse', 'amyls', 'audio', 'basic',
  'crane', 'dealt', 'earth', 'faith', 'ghost', 'happy', 'ideal', 'judge', 'knife', 'lemon',
  'magic', 'naive', 'ocean', 'panic', 'query', 'raven', 'saint', 'teach', 'urban', 'value',
